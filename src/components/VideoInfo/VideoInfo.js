    ...
    return (
        <div className='videoinfo'>
            ...
            <div className='videoinfo__stats'>
                <p>{viewCount} vues • {publishedDate}</p>
                <div className="videoinfo__likes">
                    ...
                    <SideBarRow Icon={ReplyIcon} title='PARTAGE' />
                    <SideBarRow Icon={PlaylistAddIcon} title='ENREGISTRER' />
            ...
            <div className="videoinfo__channel">
                <div>
                    ...
                    <div className='videoinfo__channelinfo'>
                        ...
                        <p className='videoinfo__channelsubs'>{subs} Abonnés</p>
                    </div>
                    
                </div>
                <div className='videoinfo__subscribe'>
                    <Button color='secondary' >Abonne-toi</Button>
                </div>
            </div>
